...
router.get('/', (req, res, next) => {
  ...
  userService
    .getAllUsers(req.query.pageNumber)
    .then(data => res.json(
      data
    ))
    .catch(err => next(err));
 ...
 * PUT /api/users/:id
 */
router.put('/:id', findUser, userPutValidator,/*authenticateUser,*/ (req, res, next) => {
  userService
 ...
 * DELETE /api/users/:id
 */
router.delete('/:id', findUser, /*authenticateUser,*/(req, res, next) => {
  userService
